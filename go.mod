...
require (
	...
	github.com/openshift-kni/numaresources-operator v0.4.12-0.2022111801.0.20230119155952-376b0302246a
	...
	github.com/openshift/ptp-operator v0.0.0-20230120025914-ae56875d0f51
...
require (
	...
	github.com/k8stopologyawareschedwg/deployer v0.10.1 // indirect
	github.com/k8stopologyawareschedwg/noderesourcetopology-api v0.0.13 // indirect
	github.com/k8stopologyawareschedwg/resource-topology-exporter v0.9.1-0.20221116094504-e3d2ea60f7cb // indirect
...
replace (
	...
	github.com/openshift-kni/numaresources-operator => github.com/openshift-kni/numaresources-operator v0.4.12-0.2022111801.0.20230119155952-376b0302246a // release-4.13
